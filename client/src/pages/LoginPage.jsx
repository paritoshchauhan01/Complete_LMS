      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition font-medium shadow-sm"
          >
            <GoogleIcon />
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-gray-400 dark:text-gray-500">
              <span className="px-2 bg-white dark:bg-gray-800">Teacher / Admin?</span>
            </div>
          </div>
